...
Note: If you are not working on a RAGE-on-SSD you'll first have to download the MADDOG repo and create the conda environment. Instructions on how to do this are found at: https://github.com/KathrynCampbell/MADDOG 
